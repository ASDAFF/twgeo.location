 ...
 */
use TWGeo\Location\Location\Sale2;
use TWGeo\Location\Location\Sale;
use \TWGeo\Location\Location;

/**
 * Class TWG_LOCATION_SaleLocation
 *
 * @author Pavel Shulaev (https://rover-it.me)
 * @deprecated
 */
class TWG_LOCATION_SaleLocation
{
    ...
    {
        if (!$cityName)
            $cityName = TWG_LOCATION_Location::getCurrentCityName($langId);
