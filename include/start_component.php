...
if($APPLICATION->GetCurDir() != '/bitrix/admin/'){
	...
	$template = Option::get('twgeo.location', 'sale-order-template', '.default');

	$APPLICATION->IncludeComponent("twgeo:location", $template, array('ORDER_TEMPLATE'=>'Y', 'PARAMS'=>$arParams));
