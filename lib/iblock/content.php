...
class Content extends Iblock
{
    ...
    const CODE                  = 'twg_location_locations';
    ...
    protected static function createDefaultElement()
    {
        ...
        $fields = [
            'NAME'      => Loc::getMessage('TWGL_IBLOCK_CONTENT_DEFAULT'),
    ...
    public static function createIblock()
    {
        ...
        $id = self::create(self::CODE, Loc::getMessage('TWGL_IBLOCK_CONTENT_NAME'), Loc::getMessage('TWGL_IBLOCK_CONTENT_DESCRIPTION'));
    ...
    public static function createIblockDomainProperty()
    {
        ...
        $arFields = Array(
            "NAME"          => Loc::getMessage('TWGL_IBLOCK_CONTENT_PROP_DOMAIN'),
            "ACTIVE"        => "Y",
            "SORT"          => "300",
