 ...
 * Class Location
 *
 * @package TWGeo\Location\Iblock
 */
class Location extends Iblock
{
    const CODE              = 'twg_location_location';
    ...
    public static function addCountries()
    {
        ...
        $countries  = [Loc::getMessage('TWGL_IBLOCK_LOCATION_RUSSIA')];
    ...
    public static function addRegions()
    {
        ...
        foreach ($regions as $region)
        {
            ...
            $countryCode = isset($region[6])
                ...
                : \CUtil::translit(Loc::getMessage('TWGL_IBLOCK_LOCATION_RUSSIA'), LANGUAGE_ID, ['replace_space' => '-', 'replace_other' => '-']);
    ...
    public static function createIblock()
    {
        ...
        $id = self::create(self::CODE, Loc::getMessage('TWGL_IBLOCK_LOCATION_NAME'), Loc::getMessage('TWGL_IBLOCK_LOCATION_DESCRIPTION'));
