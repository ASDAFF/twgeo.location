...
class Iblock
{
    ...
    public static function createType()
    {
        ...
        $fields = [
            ...
            'LANG' => [
                ...
                'ru' => [
                    'NAME'          => Loc::getMessage('TFL_IBLOCK_TYPE_NAME'),
                    'SECTION_NAME'  => Loc::getMessage('TFL_IBLOCK_TYPE_ELEMENT_NAME'),
                    'ELEMENT_NAME'  => Loc::getMessage('TFL_IBLOCK_TYPE_SECTION_NAME')
                ]
            ]
        ];
    ...
    protected static function createCheckBoxProperty($code, $sort = 100)
    {
        ...
        $arFields = Array(
            "NAME"          => Loc::getMessage('TFL_IBLOCK_PROP_' . $code),
            "HINT"          => Loc::getMessage('TFL_IBLOCK_PROP_' . $code .'_HINT'),
            "ACTIVE"        => "Y",
            "SORT"          => $sort,
            "CODE"          => $code,
            "PROPERTY_TYPE" => "L",
